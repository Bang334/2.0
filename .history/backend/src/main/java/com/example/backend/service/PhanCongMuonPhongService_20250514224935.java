...
public class PhanCongMuonPhongService {
    ...
    public PhanCongMuonPhong taoPhanCong(String maSVNguoiPhanCong, String maSVNguoiDuocPhanCong, 
        ...
        boolean daCoNguoiDuocPhanCong = phanCongMuonPhongRepository
            .existsByNguoiDuocPhanCongAndThoiKhoaBieuAndTrangThaiNot(
                nguoiDuocPhanCong, thoiKhoaBieu, PhanCongMuonPhong.TrangThai.TUCHOI);
        ...
        phanCong.setTrangThai(PhanCongMuonPhong.TrangThai.CHUAXULY);
     ...
     */
    @Transactional
    public PhanCongMuonPhong capNhatTrangThai(Integer maPhanCong, PhanCongMuonPhong.TrangThai trangThai, String lyDo) throws Exception {
        ...
        // Nếu trạng thái là TUCHOI và có lý do, lưu lý do từ chối
        if (trangThai == PhanCongMuonPhong.TrangThai.TUCHOI && lyDo != null && !lyDo.trim().isEmpty()) {
            phanCong.setLyDoTuChoi(lyDo);
        }
    ...
    public void huyPhanCong(Integer maPhanCong, String maSVCanBo) throws Exception {
        ...
        // Thay vì cập nhật trạng thái, xóa bản ghi hoàn toàn khỏi database
        phanCongMuonPhongRepository.delete(phanCong);
    }
} 