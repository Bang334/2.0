...
import { FaInbox, FaPaperPlane, FaTrash, FaEye } from "react-icons/fa";
                ...
                <tr key={tb.id} className={tb.trangThai === 'CHUADOC' ? 'chuadoc' : ''}>
                  ...
                  <td>
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => handleXoaThongBao(tb.id)}
                      disabled={deleting}
                    >
      ...
      >
        ...
        <Modal.Footer>
          <Button variant="outline-danger" onClick={() => {
            const thongBaoId = selectedThongBao?.id;
            closeThongBaoDetail();
            if (thongBaoId) {
              handleXoaThongBao(thongBaoId);
            }
          }} className="me-2">
