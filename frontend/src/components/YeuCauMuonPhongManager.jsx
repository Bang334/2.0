...
const YeuCauMuonPhongManager = () => {
  ...
  const renderTrangThai = (trangThai) => {
    switch (trangThai) {
      case "DANGXULY":
        return <Badge className="badge-processing">Đang xử lý</Badge>;
      case "DADUYET":
        return <Badge className="badge-approved">Đã duyệt</Badge>;
      case "KHONGDUOCDUYET":
        return <Badge className="badge-rejected">Không được duyệt</Badge>;
      default:
      ...
      <Card className="mb-4">
        ...
        <Card.Body>
          ...
          <div className="table-scrollable">
            <Table className="align-middle yeucau-table">
              <thead>
                <tr>
                  <th>Mã YC</th>
                  <th>Người mượn</th>
