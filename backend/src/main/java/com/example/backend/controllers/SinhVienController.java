...
public class SinhVienController {
    ...
    public ResponseEntity<?> traPhongHoc(@PathVariable Integer maYeuCau) {
        ...
        // So sánh với thời gian trả ban đầu
    ...
    @GetMapping("/check-vaitro")
    @PreAuthorize("hasRole('SV')")
    public ResponseEntity<?> checkVaiTroSinhVien() {
        System.out.println("DEBUG: checkVaiTroSinhVien endpoint called");
        ...
        System.out.println("DEBUG: Found sinh viên: " + sinhVien.getMaSV() + ", vai trò: " + sinhVien.getVaiTro());
        
        // Tạo đối tượng trả về
        Map<String, Object> response = new HashMap<>();
        response.put("maSV", sinhVien.getMaSV());
        response.put("vaiTro", sinhVien.getVaiTro().toString());
        response.put("isCanBo", sinhVien.getVaiTro() == SinhVien.VaiTroSinhVien.CANBO);
